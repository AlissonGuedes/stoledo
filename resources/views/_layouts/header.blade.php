...
@section('search-name', 'Pesquisar na página')
    ...
    <header class="page-topbar" id="header">
        <div class="navbar navbar-fixed">
            <nav class="navbar-main navbar-color nav-collapsible grey lighten-4 grey-text text-darken-4">
                <div class="nav-wrapper">

                    <div class="header">
                        <div class="page-title">
                        @section('header')
                            <h5 class="title white-text">@yield('page-title')</h5>
                        @show
                    </div>

                    @section('search')
                        <div class="header-search-wrapper hide-on-med-and-down right bordered grey-text">
                            <label for="search">
