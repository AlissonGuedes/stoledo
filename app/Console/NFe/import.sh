...
do
	...
	do
		...
		then
			...
			# IND_PGTO=$(echo $REGISTRO | cut -d '|' -f 13)

			VL_DESC=$([[ $(echo $REGISTRO | cut -d '|' -f 49) != '' ]] && echo $REGISTRO | cut -d '|' -f 49 | sed 's/\.//g' | sed 's/\,/\./g' || echo 0.00 )
			# VL_ABAT_NT=$([[ $(echo $REGISTRO | cut -d '|' -f 15) != '' ]] && echo $REGISTRO | cut -d '|' -f 15 | sed 's/\,/\./g' || echo 0.00 )
			...
			# VL_PIS=$([[ $(echo $REGISTRO | cut -d '|' -f 26) != '' ]] && echo echo $REGISTRO | cut -d '|' -f 26 | sed 's/\,/\./g' || echo 0.00 )
			# VL_COFINS=$([[ $(echo $REGISTRO | cut -d '|' -f 27) != '' ]] && echo $REGISTRO | cut -d '|' -f 27 | sed 's/\,/\./g' || echo 0.00 )
			# VL_PIS_ST=$([[ $(echo  $REGISTRO | cut -d '|' -f 28) != '' ]] && echo $REGISTRO | cut -d '|' -f 28 | sed 's/\,/\./g' || echo 0.00 )
			# VL_COFINS_ST=$([[ $(echo $REGISTRO | cut -d '|' -f 29) != '' ]] && echo $REGISTRO | cut -d '|' -f 29 | sed 's/\,/\./g' || echo 0.00 )
