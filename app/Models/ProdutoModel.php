...
namespace App\Models {
	...
	class ProdutoModel extends Authenticatable {
		...
		protected $table = 'tb_nfe_item';

		public function __construct() {
			$this -> produto = new Produto();
		}

		public function insertItens($det ) {

			// echo '<pre>';

			// $produto = $this -> produto -> fill($det -> prod);

			// $hasFornecedor = $this -> select('id', 'xProd', 'cProd', 'cEAN', 'ncm', 'cfop', 'uCom', 'vTotTrib', 'cest', 'indEscala', 'vUnCom', 'vProd', 'cEANTrib', 'uTrib', 'qTrib', 'vUnTrib', 'indTot', 'xPed', 'nItemProd')
			// 					   -> from('tb_nfe_item')
			// 					   -> where('id_nfe', $nfe)
			// 					   -> first();
